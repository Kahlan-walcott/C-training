...
This is odd, the condition came after the statements. Does this mean the condition isn’t checked until after the
statements get executed?

That is exactly what happens!

This is what’s known as a do-while loop. Simply put, it does something first, and then checks the condition afterward
and loops in this manner until the condition is no longer true.
...
/* You may have noticed there wasn’t a difference between 
the outputs of this particular while loop and do -while loop.
