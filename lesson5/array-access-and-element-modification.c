...
int main() {
    ...
    printf("%i\n", evens[6]); // Checkpoint 1. Fix this error.
...
int main() {
    ...
    int evens[] = {2, 4, 6, 8, 10, 12};
    int odds[] = {1, 4, 5, 7, 10, 11}; // Do not modify this line.
    printf("%i\n", evens[5]); // Checkpoint 1. Fix this error. The accompanying code erroneously attempts to print the last value in the evens array. Fix this bug.

    // Code for checkpoint 2 goes here.
    printf("%i\n", evens[2]); // Print the third element of the evens array.
    // Code for checkpoint 3 goes here.The odds array given is intended to contain the first six odd numbers.Notice that some values are incorrect.Fix them by changing their value to the correct odd number.Do this by using array access.
    odds[1] = 3;
    odds[4] = 9;
}
